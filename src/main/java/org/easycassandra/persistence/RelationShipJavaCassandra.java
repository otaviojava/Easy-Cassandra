...
INSTANCE;
  ...
  */
 Map<String, String> mapCQL;
 /**
  * key is Java and value is CQL
  */
 Map<String, List<String>> mapJava;

{
	...
	public Object getObject(Row row,Name cqlType,String name){
		switch (cqlType) {
		case ASCII: case TEXT: case VARCHAR:
		return row.getString(name);
		case BIGINT: case COUNTER:
		return row.getLong(name);
		case BOOLEAN:
		return row.getBool(name);
		case BLOB: case CUSTOM:
